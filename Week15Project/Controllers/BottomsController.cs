...
namespace Week15Project.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomID,Nickname,Photo,Type,Color,Season,Occasion")] Bottoms bottoms)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomID,Nickname,Photo,Type,Color,Season,Occasion")] Bottoms bottoms)
        {
            if (ModelState.IsValid)
            {

...
namespace Week15Project.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoeID,Nickname,Photo,Type,Color,Season,Occasion")] Shoes shoes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoeID,Nickname,Photo,Type,Color,Season,Occasion")] Shoes shoes)
        {
            if (ModelState.IsValid)
            {

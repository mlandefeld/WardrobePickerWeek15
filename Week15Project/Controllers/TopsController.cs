...
namespace Week15Project.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopID,Nickname,Photo,Type,Color,Season,Occasion")] Tops tops)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopID,Nickname,Photo,Type,Color,Season,Occasion")] Tops tops)
        {
            if (ModelState.IsValid)
            {
